/*
 1.  --accesslog=d:\\programming\\interviews\\WalletHub\\access.log --startDate=2017-01-01.15:00:00 --duration=hourly --threshold=200
*/
...
/*
 2.  --accesslog=d:\\programming\\interviews\\WalletHub\\access.log --startDate=2017-01-01.00:00:00 --duration=daily --threshold=500
*/
select ip_address, count(ip_address) from log_entries
